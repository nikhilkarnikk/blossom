...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50 scroll-smooth snap-y snap-mandatory">
      ...
      <section id="hero" className="min-h-screen relative flex flex-col items-start overflow-hidden snap-start">
        ...
        <div className="relative z-10 mt-20 md:mt-28 lg:mt-36 mx-4 md:ml-12 lg:ml-24 max-w-2xl">
          <div className="bg-white bg-opacity-80 p-5 md:p-7 lg:p-10 space-y-4 md:space-y-5">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-6">
              <button className="text-black font-light text-lg md:text-xl font-montserrat tracking-wide hover:text-gray-700 border-b-2 border-transparent hover:border-black pb-1 transition-all duration-200 px-3">
                <span>Sign Up For</span>
                <span>Early Access</span>
              </button>
              <button 
                onClick={scrollToOverview}
                className="text-black font-light text-lg md:text-xl font-montserrat tracking-wide hover:text-gray-700 border-b-2 border-transparent hover:border-black pb-1 transition-all duration-200 px-3"
              >
                Learn More
              </button>
            </div>
        ...
        {/* Feature boxes */}
        <div className="absolute bottom-6 left-0 right-0 z-10 px-4 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className="bg-white bg-opacity-80 p-5 flex flex-col justify-center h-full"
              >
                <h3 className="text-base md:text-lg font-bold text-black mb-2">
                  {feature.title}
                </h3>
                <p className="text-sm md:text-base text-black text-opacity-90 leading-relaxed">
                  {feature.description}
                </p>
              </div>
            ))}
...
<section id="overview" className="h-screen relative flex items-center justify-center bg-[#68917b] snap-start">
  ...
  <div className="absolute left-0 top-1/2 transform -translate-y-1/2 flex flex-col items-center w-1/2 px-8 hidden [@media(min-aspect-ratio:1/1)]:flex">
    <div className="w-2/3 my-8">
      <div className="h-[38rem]"> {/* Fixed height container */}
        <img 
          src="/assets/ov1.JPG" 
  ...
  <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-full [@media(min-aspect-ratio:1/1)]:w-1/2 px-8">
    <h2 className="text-4xl sm:text-6xl font-semibold text-white leading-tight">  
      ...
      <section id="intro" className="h-screen relative flex items-center bg-[#d1aa6c] p-12 snap-start">
        <div className="w-full h-full bg-white grid grid-cols-1 [@media(min-aspect-ratio:1/1)]:grid-cols-2">
          ...
          <div className="hidden [@media(min-aspect-ratio:1/1)]:flex items-center justify-center pr-16">
